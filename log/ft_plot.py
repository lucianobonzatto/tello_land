...
x = ler_csv("log/csv/ft/uav_x.csv")
y = ler_csv("log/csv/ft/uav_y.csv")
z = ler_csv("log/csv/ft/uav_z.csv")
r = ler_csv("log/csv/ft/uav_r.csv")
...
uav_xf.to_csv("log/csv/ft/uav_x.csv", index=False)
uav_yf.to_csv("log/csv/ft/uav_y.csv", index=False)
uav_zf.to_csv("log/csv/ft/uav_z.csv", index=False)
uav_rf.to_csv("log/csv/ft/uav_r.csv", index=False)
